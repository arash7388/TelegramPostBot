...
namespace Console
{
    class Program
    {
        private static readonly TelegramBotClient Bot = new TelegramBotClient("530141660:AAFA0WTxChkKt-IEyjnvricUCKqMmZoXr6Y");
        ...
        private static string  Instructions = @"به بات داتین خوش آمدید
/Register - ثبت نام";
        ...
        private static async void BotOnMessageReceived(object sender, MessageEventArgs messageEventArgs)
        {
            ...
            //}
            //else 
            if (message.Text.StartsWith("/Register")) // send custom keyboard
            {
